  ...
  return (
    <>
      {isShowModal && area && (
        <div
          tabIndex={-1}
          className="fixed top-0 right-0 z-50 bg-slate-300 bg-opaarea-50 p-4 overflow-x-hidden overflow-y-auto h-modal md:h-full transition-all flex-auto w-96 from-slate-900 to-blue-600 modal-fade"
        >
